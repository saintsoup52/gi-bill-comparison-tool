...
var GIBComparisonTool = function () {
  ...
  var TFCAP  = 19198,
      ...
      GROUP5GRADMED  = 62.4,
      GROUP5GRADHIGH = 77,
      GROUP1GRADRANKHIGH = 703,
      GROUP1GRADRANKMED  = 1407,
      GROUP1GRADRANKMAX  = 1873,
      GROUP2GRADRANKHIGH = 607,
      GROUP2GRADRANKMED  = 1219,
      GROUP2GRADRANKMAX  = 1390,
      GROUP3GRADRANKHIGH = 273,
      GROUP3GRADRANKMED  = 541,
      ...
      GROUP5LOANMED  = 7321,
      GROUP5LOANHIGH = 9500,
      GROUP1LOANRANKMED  = 667,
      GROUP1LOANRANKHIGH = 1333,
      GROUP1LOANRANKMAX  = 2000,
      GROUP2LOANRANKMED  = 470,
      GROUP2LOANRANKHIGH = 939,
      GROUP2LOANRANKMAX  = 1409,
      GROUP3LOANRANKMED  = 242,
      GROUP3LOANRANKHIGH = 485,
